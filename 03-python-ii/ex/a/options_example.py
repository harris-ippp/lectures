...
if __name__ == "__main__":
  ...
  import argparse
  parser = argparse.ArgumentParser(description='Options example: print ratios from the ACS 2014.  For variables, see: http://api.census.gov/data/2014/acs5/variables.html')
